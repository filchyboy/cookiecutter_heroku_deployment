...
content = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span("Chris Filkins", className="mr-2"),
                    html.A(
                        html.I(className="fas fa-envelope-square mr-1"),
                        href="mailto:filchyboy@gmail.com",
                    ),
                    html.A(
                        html.I(className="fab fa-github-square mr-1"),
                        href="https://github.com/filchyboy",
                    ),
                    html.A(
                        html.I(className="fab fa-linkedin mr-1"),
                        href="https://www.linkedin.com/in/https://www.linkedin.com/in/chrisfilkins//",
                    ),
                    html.A(
                        html.I(className="fab fa-twitter-square mr-1"),
                        href="https://twitter.com/filchyboy",
                    ),
                ],
                className="lead",
            )
